      ...
      <ion-page>
        <ion-header v-show="$route.name !== 'Account'" :translucent="true">
          <ion-toolbar>
            ...
            <n-button style="margin-right: 1rem" slot="end" type="primary" round @click="changeTheme"
...
import { darkTheme, lightTheme, NConfigProvider, NButton, NMessageProvider } from 'naive-ui';
